...
//Your E-mail
$your_email = 'tykras@ya.ru';

//Default Subject if 'subject' field not specified
$default_subject = 'From My Contact Form';

//Message if 'name' field not specified
$name_not_specified = 'Пожалуйста, введите имя';

//Message if 'message' field not specified
$message_not_specified = 'Пожалуйста, введите сообщение';

//Message if e-mail sent successfully
$email_was_sent = 'Спасибо, Ваше сообщение успешно отправлено';

//Message if e-mail not sent (server not configured)
$server_not_configured = 'К сожалению, почтовый сервер не доступен';
